...
export default function Home() {
  ...
  const products = [{ n: 'test', d: 'Our \'test\' product is a cutting-edge solution designed to streamline processes, enhance efficiency, and drive business growth. With its advanced features and user-friendly interface, this product is perfect for businesses seeking to stay ahead of the competition.', i: 'https://images.pexels.com/photos/7038233/pexels-photo-7038233.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'test', d: 'The \'test\' service is a comprehensive offering that provides expert guidance, support, and consultation to help businesses navigate complex challenges and achieve their goals. Our team of experts is dedicated to delivering personalized solutions that meet the unique needs of each client.', i: 'https://images.pexels.com/photos/7038233/pexels-photo-7038233.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'test', d: 'Our \'test\' product is a innovative solution that combines advanced technology with exceptional design to deliver a seamless user experience. With its robust features and scalable architecture, this product is ideal for businesses seeking to expand their reach and boost their online presence.', i: 'https://images.pexels.com/photos/17658363/pexels-photo-17658363.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'test', d: 'The \'test\' service is a specialized offering that provides businesses with expert analysis, strategy, and implementation to drive growth, improve performance, and enhance competitiveness. Our team of experts is committed to delivering tailored solutions that meet the unique needs of each client.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'test', d: 'Our \'test\' product is a groundbreaking solution that leverages the latest advancements in technology to deliver exceptional results. With its intuitive interface and advanced features, this product is perfect for businesses seeking to revolutionize their operations and stay ahead of the curve.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Test, we are dedicated to providing innovative solutions to meet the evolving needs of our customers. With a commitment to excellence and a passion for quality, we strive to deliver exceptional products and services that exceed expectations. Our team of experts is driven to make a positive impact in our industry.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">Our vision is to become a leading provider of top-notch products and services, renowned for our commitment to excellence, customer satisfaction, and continuous innovation.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">Our mission is to design, develop, and deliver high-quality products and services that meet the unique needs of our customers, while fostering a culture of innovation, integrity, and customer-centricity.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">tets</h4>
                  <p className="text-sm text-on-surface-variant">At Test, our first core value, \'tets\', represents our unwavering commitment to fostering a culture of transparency, ethics, and trust in all our interactions, whether with customers, partners, or colleagues.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">test</h4>
                  <p className="text-sm text-on-surface-variant">Our second core value, \'test\', embodies our passion for continuous learning, improvement, and innovation, as we strive to stay ahead of the curve and deliver cutting-edge solutions that meet the evolving needs of our customers.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/7580645/pexels-photo-7580645.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              ...
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/8539653/pexels-photo-8539653.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
